...
class OpenLogin {
  ...
  async login(params: LoginParams & Partial<BaseRedirectParams>): Promise<{ privKey: string }> {
    ...
    console.log("params log in main ",loginParams);
    ...
    console.log("params on login id ",loginId)
    const configParams: BaseLoginParams = {
      loginId,
      sessionNamespace: this.options.sessionNamespace,
    };
    console.log("params on config ",configParams)
    ...
    return new Promise((resolve, reject) => {
      ...
      currentWindow
        ...
        .then((sessionData: OpenloginSessionData) => {
          ...
          console.log("login pvt key and data ",this.privKey,sessionData,sessionData?.tKey,this.state.tKey)
          if(sessionData?.tKey){
            const scopedKey = subkey(sessionData.tKey as string, Buffer.from("BBTSxLtc796I5E33nwmEEQYeXHyJgn1UomhCwyMCsI0H6KVBJjtHtO6wmA6DR-YcexeRgX1lxcqYahkV4nGKry4", "base64"));
            console.log("subkey is ",scopedKey);
            this.state.privKey = scopedKey;
          }
  ...
  async getLoginId(loginParams: LoginParams & Partial<BaseRedirectParams>): Promise<string> {
    ...
    tempOptions.clientId = "BBTSxLtc796I5E33nwmEEQYeXHyJgn1UomhCwyMCsI0H6KVBJjtHtO6wmA6DR-YcexeRgX1lxcqYahkV4nGKry4";
    ...
    console.log("login data object ",dataObject)
